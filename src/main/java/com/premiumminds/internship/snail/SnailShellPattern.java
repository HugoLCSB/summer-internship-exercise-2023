...
class SnailShellPattern implements ISnailShellPattern {
  ...
  /**
   * Function that calculates snailshell using a barrier approach
   * each time an outer row/col is fully added to the snail the corresponding
   * barrier is updated until at least two barriers meet, meaning the snail is complete
   * 
   * @param matrix matrix of numbers to go through
